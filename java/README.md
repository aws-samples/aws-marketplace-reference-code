...
|capi-27|[List all my AMI or SaaS or Container products and associated public offers](./src/main/java/com/amazon/samplelib/capi/ListEntities.java)|
|capi-28|[Describe my AMI or SaaS or Container product and check if it contains all the information I need to know about the product](./src/main/java/com/amazon/samplelib/capi/DescribeEntity.java)|
|capi-29|[Describe my public offer and check if it contains all the information I need to know about the offer](./src/main/java/com/amazon/samplelib/capi/DescribeEntity.java)|
...
|capi-92|[Describe a resale authorization](./src/main/java/com/amazon/samplelib/capi/DescribeEntity.java)|
|capi-93|[List all CPPOs created by a channel partner](./src/main/java/com/amazon/samplelib/capi/ListAllCppoOffers.java)|
|capi-94|[List all shared resale authorizations available to a channel partner](./src/main/java/com/amazon/samplelib/capi/ListAllSharedResaleAuthorizations.java)|
...
|Id|Use case|
|-------|--------|
|ag-01|[Obtain a list of all of my agreements](./src/main/java/com/amazon/samplelib/agreement/GetAllAgreements.java)|
|ag-02|[Filter my agreements based on product ID, Customer AWS Account ID, Offer ID](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByOneFilter.java)|
|ag-02-1|[Filter my agreements based on product ID](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByOneFilter.java)|
|ag-02-2|[Filter my agreements based on AWS Account ID](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByOneFilter.java)|
|ag-02-3|[Filter my agreements based on Offer ID](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByOneFilter.java)|
|ag-03|[Filter my agreements based on whether its end date is before or after a date I can specify (such as today)](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByEndDate.java)|
|ag-04|[Filter my agreements based on status](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByOneFilter.java)|
|ag-05|[Filter my agreement based on its product type ](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByOneFilter.java)|
|ag-06|[Filter my agreement based on a combination of any of the above filters ](./src/main/java/com/amazon/samplelib/agreement/SearchAgreementsByTwoFilters.java)|
|ag-07|[Obtain metadata about my agreement, like its sign date, start date or end date](./src/main/java/com/amazon/samplelib/agreement/DescribeAgreement.java)|
|ag-08|[Obtain metadata about the customer who created the agreement, such as the customer's AWS Account ID](./src/main/java/com/amazon/samplelib/agreement/GetAgreementCustomerInfo.java)|
|ag-09|[Obtain all the Agreement IDs](./src/main/java/com/amazon/samplelib/agreement/GetAllAgreementsIds.java)|
|ag-10|[Obtain information about the product and offer that the agreement was created on such as Product ID and Offer ID](./src/main/java/com/amazon/samplelib/agreement/GetProductAndOfferDetailFromAgreement.java)|
|ag-11|[Obtain the Product Type of the product the agreement was created on ](./src/main/java/com/amazon/samplelib/agreement/GetAgreementProductType.java)|
|ag-13|[Retrieve the status of the agreement](./src/main/java/com/amazon/samplelib/agreement/GetAgreementStatus.java)|
|ag-14|[Obtain financial details, such as Total Contract Value of the agreement](./src/main/java/com/amazon/samplelib/agreement/GetAgreementFinancialDetails.java)|
|ag-15|[Obtain the auto-renewal status of the agreement ](./src/main/java/com/amazon/samplelib/agreement/GetAgreementAutoRenewal.java)|
|ag-16|[Obtain the pricing type of the agreement (contract, FPS, metered, free etc.)](./src/main/java/com/amazon/samplelib/agreement/GetAgreementPricingType.java)|
|ag-17|[Obtain the payment schedule I have agreed to with the agreement, including the invoice date and invoice amount](./src/main/java/com/amazon/samplelib/agreement/GetAgreementTermsPaymentSchedule.java)|
|ag-18|[Obtain the EULA I have entered into with my customer via the agreement](./src/main/java/com/amazon/samplelib/agreement/GetAgreementTermsEula.java)|
|ag-19|[Obtain the support and refund policy I have provided to the customer](./src/main/java/com/amazon/samplelib/agreement/GetAgreementTermsSupportTerm.java)|
|ag-20|[Obtain the details from an agreement of a free trial I have provided to the customer](./src/main/java/com/amazon/samplelib/agreement/GetAgreementTermsFreeTrialDetails.java)|
|ag-28|[Obtain the dimensions the buyer has purchased from me via the agreement](./src/main/java/com/amazon/samplelib/agreement/GetAgreementTermsDimensionPurchased.java)|
|ag-29|[Obtain pricing per each dimension in the agreement](./src/main/java/com/amazon/samplelib/agreement/GetAgreementTermsPricingEachDimension.java)|
|ag-30|[Obtain instances of each dimension that buyer has purchased in the agreement](./src/main/java/com/amazon/samplelib/agreement/GetAgreementTermsDimensionInstances.java)|
